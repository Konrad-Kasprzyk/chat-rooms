import createUserDocuments from "backend/user/createUserDocuments.service";
 ...
 * idToken, and creates user documents.
...
export async function POST(request: NextRequest) {
  try {
    ...
    const createdUserDocId = await createUserDocuments(uid, username, email, testCollections);
