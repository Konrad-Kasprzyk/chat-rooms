...
function createTypedQuery<T extends object>(actualQuery: Query<T>): TypedQuery<T> {
  ...
  const startAtQuery = actualQuery.startAt;
  const startAfterQuery = actualQuery.startAfter;
  ...
  typedQuery.startAt = (...args: Parameters<typeof startAtQuery>) =>
    createTypedQuery(startAtQuery.call(actualQuery, ...args));
  typedQuery.startAfter = (...args: Parameters<typeof startAfterQuery>) =>
    createTypedQuery(startAfterQuery.call(actualQuery, ...args));
...
function createTypedCollection<T extends object>(adminDb: Firestore, collectionPath: string) {
  ...
  const limitQuery = collection.limit;
  const limitToLastQuery = collection.limitToLast;
  const startAtQuery = collection.startAt;
  const startAfterQuery = collection.startAfter;
  ...
  typedCollection.limit = (...args: Parameters<typeof limitQuery>) =>
    createTypedQuery(limitQuery.call(collection, ...args));
  typedCollection.limitToLast = (...args: Parameters<typeof limitToLastQuery>) =>
    createTypedQuery(limitToLastQuery.call(collection, ...args));
  typedCollection.startAt = (...args: Parameters<typeof startAtQuery>) =>
    createTypedQuery(startAtQuery.call(collection, ...args));
  typedCollection.startAfter = (...args: Parameters<typeof startAfterQuery>) =>
    createTypedQuery(startAfterQuery.call(collection, ...args));
...
export default function createAdminCollections(adminDb: Firestore, testCollectionsId?: string) {
  ...
  return {
    goalArchives: createTypedCollection<ArchivedGoalsDTO>(adminDb, collectionPaths.goalArchives),
    taskArchives: createTypedCollection<ArchivedTasksDTO>(adminDb, collectionPaths.taskArchives),
    columnHistories: createTypedCollection<ColumnsHistoryDTO>(
      adminDb,
      collectionPaths.columnHistories
    ),
    goalHistories: createTypedCollection<GoalHistoryDTO>(adminDb, collectionPaths.goalHistories),
    labelHistories: createTypedCollection<LabelsHistoryDTO>(
      adminDb,
      collectionPaths.labelHistories
    ),
    taskHistories: createTypedCollection<TaskHistoryDTO>(adminDb, collectionPaths.taskHistories),
    userHistories: createTypedCollection<UsersHistoryDTO>(adminDb, collectionPaths.userHistories),
