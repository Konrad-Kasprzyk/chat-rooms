 ...
 * overwritten.
 */
export default async function testWorkspaceHistoryNotFoundError(
  ...
  await adminCollections.workspaceHistories.doc(workspace!.newestWorkspaceHistoryId).delete();
