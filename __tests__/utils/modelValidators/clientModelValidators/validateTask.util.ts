...
const validateTask = (input: any): Task => {
    const __is = (input: any, _exceptionable: boolean = true): input is Task => {
        ...
        const $io1 = (input: any, _exceptionable: boolean = true): boolean => "string" === typeof input.id && 1 <= input.id.length && ("string" === typeof input.email && /^(([^<>()[\]\.,;:\s@\"]+(\.[^<>()[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i.test(input.email)) && "string" === typeof input.username && (Array.isArray(input.workspaceIds) && input.workspaceIds.every((elem: any, _index5: number) => "string" === typeof elem && 1 <= elem.length)) && (Array.isArray(input.workspaceInvitationIds) && input.workspaceInvitationIds.every((elem: any, _index6: number) => "string" === typeof elem && 1 <= elem.length)) && "boolean" === typeof input.isBotUserDocument && input.modificationTime instanceof Date && input.fetchingFromSeverTime instanceof Date && "boolean" === typeof input.hasOfflineChanges && (9 === Object.keys(input).length || Object.keys(input).every((key: any) => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is Task => {
            ...
            const $ao0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("string" === typeof input.id && (1 <= input.id.length || $guard(_exceptionable, {
                ...
                expected: "((string & MinLength<1>) | null)",
                value: input.goalId
            })) && ("boolean" === typeof input.isLoadingGoal || $guard(_exceptionable, {
            ...
            })) && (30 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every((key: any) => {
                if (["id", "urlNumber", "workspaceId", "title", "description", "author", "authorId", "assignedUser", "assignedUserId", "column", "columnId", "goal", "goalId", "isLoadingGoal", "storyPoints", "firstIndex", "secondIndex", "labels", "labelIds", "priority", "objectives", "notes", "modificationTime", "columnChangeTime", "completionTime", "creationTime", "newestHistoryId", "placingInBinTime", "fetchingFromSeverTime", "hasOfflineChanges"].some((prop: any) => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
            ...
            const $ao3 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("string" === typeof input.id && (1 <= input.id.length || $guard(_exceptionable, {
            ...
            })) && input.columnTasksCount.every((elem: any, _index7: number) => ("object" === typeof elem && null !== elem && false === Array.isArray(elem) || $guard(_exceptionable, {
                path: _path + ".columnTasksCount[" + _index7 + "]",
                expected: "__type",
                value: elem
            })) && $ao4(elem, _path + ".columnTasksCount[" + _index7 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".columnTasksCount[" + _index7 + "]",
                expected: "__type",
                value: elem
            })) || $guard(_exceptionable, {
            ...
            })) && input.columnTasksStoryPoints.every((elem: any, _index8: number) => ("object" === typeof elem && null !== elem && false === Array.isArray(elem) || $guard(_exceptionable, {
                path: _path + ".columnTasksStoryPoints[" + _index8 + "]",
                expected: "__type.o1",
                value: elem
            })) && $ao5(elem, _path + ".columnTasksStoryPoints[" + _index8 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".columnTasksStoryPoints[" + _index8 + "]",
                expected: "__type.o1",
                value: elem
            })) || $guard(_exceptionable, {
                ...
                value: input.objectives
            })) && input.objectives.every((elem: any, _index9: number) => ("object" === typeof elem && null !== elem || $guard(_exceptionable, {
                path: _path + ".objectives[" + _index9 + "]",
                expected: "__type.o2",
                value: elem
            })) && $ao6(elem, _path + ".objectives[" + _index9 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".objectives[" + _index9 + "]",
                expected: "__type.o2",
                value: elem
            })) || $guard(_exceptionable, {
                ...
                value: input.notes
            })) && input.notes.every((elem: any, _index10: number) => ("object" === typeof elem && null !== elem || $guard(_exceptionable, {
                path: _path + ".notes[" + _index10 + "]",
                expected: "__type.o3",
                value: elem
            })) && $ao7(elem, _path + ".notes[" + _index10 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".notes[" + _index10 + "]",
                expected: "__type.o3",
                value: elem
            })) || $guard(_exceptionable, {
                ...
                expected: "boolean",
                value: input.hasOfflineChanges
            })) && (27 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every((key: any) => {
                if (["id", "urlNumber", "workspaceId", "title", "description", "author", "authorId", "storyPoints", "firstIndex", "secondIndex", "allTasksCount", "allTasksStoryPoints", "completedTasksCount", "completedTasksStoryPoints", "columnTasksCount", "columnTasksStoryPoints", "objectives", "notes", "deadline", "modificationTime", "lastTaskAssignmentTime", "lastTaskCompletionTime", "creationTime", "newestHistoryId", "placingInBinTime", "fetchingFromSeverTime", "hasOfflineChanges"].some((prop: any) => key === prop))
                    return true;
                const value = input[key];
                if (undefined === value)
