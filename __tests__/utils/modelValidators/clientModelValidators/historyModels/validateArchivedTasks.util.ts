    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is ArchivedTasks => {
            ...
            const $ao3 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("string" === typeof input.id && (1 <= input.id.length || $guard(_exceptionable, {
                ...
                expected: "Label",
                value: elem
            })) && $ao4(elem, _path + ".labels[" + _index4 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".labels[" + _index4 + "]",
                expected: "Label",
                value: elem
            })) || $guard(_exceptionable, {
                ...
                expected: "__type",
                value: elem
            })) && $ao5(elem, _path + ".objectives[" + _index5 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".objectives[" + _index5 + "]",
                expected: "__type",
                value: elem
            })) || $guard(_exceptionable, {
                ...
                expected: "__type.o1",
                value: elem
            })) && $ao6(elem, _path + ".notes[" + _index6 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".notes[" + _index6 + "]",
                expected: "__type.o1",
                value: elem
            })) || $guard(_exceptionable, {
