...
const validateChatHistory = (input: any, errorFactory?: (p: import("typia").TypeGuardError.IProps) => Error): ChatHistory => {
    const __is = (input: any, _exceptionable: boolean = true): input is ChatHistory => {
        ...
        const $io1 = (input: any, _exceptionable: boolean = true): boolean => "number" === typeof input.id && "message" === input.action && (null === input.user || "object" === typeof input.user && null !== input.user && $io2(input.user, true && _exceptionable)) && ("string" === typeof input.userId && 1 <= input.userId.length) && input.date instanceof Date && (null === input.oldValue || "string" === typeof input.oldValue) && (null === input.value || "string" === typeof input.value) && (7 === Object.keys(input).length || Object.keys(input).every((key: any) => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is ChatHistory => {
            ...
            const $ao0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("string" === typeof input.id && (1 <= input.id.length || $guard(_exceptionable, {
                ...
                path: _path + ".history",
                expected: "Array<DocRecord<\"message\", string>>",
                value: input.history
                ...
                expected: "DocRecord<\"message\", string>",
                value: elem
