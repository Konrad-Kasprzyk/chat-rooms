    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is ArchivedGoals => {
            ...
            const $ao1 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("number" === typeof input.id || $guard(_exceptionable, {
                ...
                path: _path + ".oldValue",
                expected: "(ArchivedGoal | null | string)",
            ...
            const $ao3 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("string" === typeof input.id && (1 <= input.id.length || $guard(_exceptionable, {
            ...
            })) && input.objectives.every((elem: any, _index4: number) => ("object" === typeof elem && null !== elem || $guard(_exceptionable, {
                path: _path + ".objectives[" + _index4 + "]",
                expected: "__type",
                value: elem
            })) && $ao4(elem, _path + ".objectives[" + _index4 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".objectives[" + _index4 + "]",
                expected: "__type",
                value: elem
            })) || $guard(_exceptionable, {
                ...
                value: input.notes
            })) && input.notes.every((elem: any, _index5: number) => ("object" === typeof elem && null !== elem || $guard(_exceptionable, {
                path: _path + ".notes[" + _index5 + "]",
                expected: "__type.o1",
                value: elem
            })) && $ao5(elem, _path + ".notes[" + _index5 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".notes[" + _index5 + "]",
                expected: "__type.o1",
                value: elem
            })) || $guard(_exceptionable, {
