...
const validateArchivedGoalsHistory = (input: any): ArchivedGoalsHistory => {
    const __is = (input: any, _exceptionable: boolean = true): input is ArchivedGoalsHistory => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is ArchivedGoalsHistory => {
