...
const validateColumnsHistoryDTO = (input: any): ColumnsHistoryDTO => {
    const __is = (input: any, _exceptionable: boolean = true): input is ColumnsHistoryDTO => {
        ...
        const $io4 = (input: any, _exceptionable: boolean = true): boolean => "string" === typeof input.name && "boolean" === typeof input.completedTasksColumn && (2 === Object.keys(input).length || Object.keys(input).every((key: any) => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is ColumnsHistoryDTO => {
