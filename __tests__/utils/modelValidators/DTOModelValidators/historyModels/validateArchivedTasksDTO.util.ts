    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is ArchivedTasksDTO => {
            ...
            const $ao2 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("number" === typeof input.id || $guard(_exceptionable, {
                ...
                expected: "number",
                value: input.id
            })) && ("docDeleted" === input.action || $guard(_exceptionable, {
                path: _path + ".action",
                expected: "\"docDeleted\"",
                value: input.action
            ...
            const $ao4 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("string" === typeof input.id && (1 <= input.id.length || $guard(_exceptionable, {
                ...
                expected: "Label",
                value: elem
            })) && $ao5(elem, _path + ".labels[" + _index1 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".labels[" + _index1 + "]",
                expected: "Label",
                value: elem
            })) || $guard(_exceptionable, {
                ...
                expected: "__type.o1",
                value: elem
            })) && $ao6(elem, _path + ".objectives[" + _index2 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".objectives[" + _index2 + "]",
                expected: "__type.o1",
                value: elem
            })) || $guard(_exceptionable, {
                ...
                expected: "__type.o2",
                value: elem
            })) && $ao7(elem, _path + ".notes[" + _index3 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".notes[" + _index3 + "]",
                expected: "__type.o2",
                value: elem
            })) || $guard(_exceptionable, {
