...
const validateArchivedTasksDTO = (input: any, errorFactory?: (p: import("typia").TypeGuardError.IProps) => Error): ArchivedTasksDTO => {
    const __is = (input: any, _exceptionable: boolean = true): input is ArchivedTasksDTO => {
        ...
        const $io4 = (input: any, _exceptionable: boolean = true): boolean => "string" === typeof input.id && 1 <= input.id.length && ("string" === typeof input.workspaceId && 1 <= input.workspaceId.length) && ("string" === typeof input.title && 1 <= input.title.length) && "string" === typeof input.description && (null === input.authorUsername || "string" === typeof input.authorUsername) && (null === input.assignedUserUsername || "string" === typeof input.assignedUserUsername) && "string" === typeof input.columnName && (null === input.goalTitle || "string" === typeof input.goalTitle) && (null === input.storyPoints || "number" === typeof input.storyPoints) && (Array.isArray(input.labels) && input.labels.every((elem: any, _index1: number) => "object" === typeof elem && null !== elem && $io5(elem, true && _exceptionable))) && (null === input.priority || "low" === input.priority || "normal" === input.priority || "high" === input.priority || "urgent" === input.priority) && (Array.isArray(input.objectives) && input.objectives.every((elem: any, _index2: number) => "object" === typeof elem && null !== elem && $io6(elem, true && _exceptionable))) && (Array.isArray(input.notes) && input.notes.every((elem: any, _index3: number) => "object" === typeof elem && null !== elem && $io7(elem, true && _exceptionable))) && input.modificationTime instanceof Date && input.columnChangeTime instanceof Date && (null === input.completionTime || input.completionTime instanceof Date) && input.creationTime instanceof Date && (null === input.placingInBinTime || input.placingInBinTime instanceof Date) && (18 === Object.keys(input).length || Object.keys(input).every((key: any) => {
        ...
        const $io7 = (input: any, _exceptionable: boolean = true): boolean => (null === input.userUsername || "string" === typeof input.userUsername) && ("string" === typeof input.note && 1 <= input.note.length) && input.date instanceof Date && (3 === Object.keys(input).length || Object.keys(input).every((key: any) => {
        ...
        ((input: any, _path: string, _exceptionable: boolean = true): input is ArchivedTasksDTO => {
            ...
            const $ao1 = (input: any, _path: string, _exceptionable: boolean = true): boolean => false === _exceptionable || Object.keys(input).every((key: any) => {
                ...
                return ("object" === typeof value && null !== value || $guard(_exceptionable, {
                    path: _path + $join(key),
                    expected: "DTODocRecord<\"docDeleted\", ArchivedTask>",
                    value: value
            ...
            const $ao4 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("string" === typeof input.id && (1 <= input.id.length || $guard(_exceptionable, {
                ...
                expected: "Label",
                value: elem
            }, errorFactory)) && $ao5(elem, _path + ".labels[" + _index1 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".labels[" + _index1 + "]",
                expected: "Label",
                value: elem
            }, errorFactory)) || $guard(_exceptionable, {
            ...
            }, errorFactory)) && input.objectives.every((elem: any, _index2: number) => ("object" === typeof elem && null !== elem || $guard(_exceptionable, {
                path: _path + ".objectives[" + _index2 + "]",
                expected: "__type.o1",
                value: elem
            }, errorFactory)) && $ao6(elem, _path + ".objectives[" + _index2 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".objectives[" + _index2 + "]",
                expected: "__type.o1",
                value: elem
            }, errorFactory)) || $guard(_exceptionable, {
                ...
                value: input.notes
            }, errorFactory)) && input.notes.every((elem: any, _index3: number) => ("object" === typeof elem && null !== elem || $guard(_exceptionable, {
                path: _path + ".notes[" + _index3 + "]",
                expected: "__type.o2",
                value: elem
            }, errorFactory)) && $ao7(elem, _path + ".notes[" + _index3 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".notes[" + _index3 + "]",
                expected: "__type.o2",
                value: elem
            }, errorFactory)) || $guard(_exceptionable, {
            ...
            const $ao7 = (input: any, _path: string, _exceptionable: boolean = true): boolean => (null === input.userUsername || "string" === typeof input.userUsername || $guard(_exceptionable, {
