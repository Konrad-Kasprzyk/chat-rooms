...
const validateWorkspaceCounterDTO = (input: any, errorFactory?: (p: import("typia").TypeGuardError.IProps) => Error): WorkspaceCounterDTO => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is WorkspaceCounterDTO => {
            ...
            const $ao0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("string" === typeof input.id && (1 <= input.id.length || $guard(_exceptionable, {
                ...
                expected: "(string & MinLength<1>)",
                value: input.id
            }, errorFactory)) && ("number" === typeof input.nextTaskUrlNumber && (Math.floor(input.nextTaskUrlNumber) === input.nextTaskUrlNumber && -2147483648 <= input.nextTaskUrlNumber && input.nextTaskUrlNumber <= 2147483647 || $guard(_exceptionable, {
                path: _path + ".nextTaskUrlNumber",
                expected: "number & Type<\"int32\">",
                value: input.nextTaskUrlNumber
            }, errorFactory)) && (1 <= input.nextTaskUrlNumber || $guard(_exceptionable, {
                path: _path + ".nextTaskUrlNumber",
                ...
                value: input.nextTaskUrlNumber
            }, errorFactory)) && ("number" === typeof input.nextGoalUrlNumber && (Math.floor(input.nextGoalUrlNumber) === input.nextGoalUrlNumber && -2147483648 <= input.nextGoalUrlNumber && input.nextGoalUrlNumber <= 2147483647 || $guard(_exceptionable, {
                path: _path + ".nextGoalUrlNumber",
                expected: "number & Type<\"int32\">",
                value: input.nextGoalUrlNumber
            }, errorFactory)) && (1 <= input.nextGoalUrlNumber || $guard(_exceptionable, {
                path: _path + ".nextGoalUrlNumber",
                expected: "number & Minimum<1>",
                value: input.nextGoalUrlNumber
            }, errorFactory)) || $guard(_exceptionable, {
                ...
                expected: "(number & Type<\"int32\"> & Minimum<1>)",
                value: input.nextGoalUrlNumber
            }, errorFactory)) && (null === input.scriptTimestamp || ("object" === typeof input.scriptTimestamp && null !== input.scriptTimestamp || $guard(_exceptionable, {
                path: _path + ".scriptTimestamp",
                expected: "(FirebaseFirestore.Timestamp | null)",
                value: input.scriptTimestamp
            }, errorFactory)) && $ao1(input.scriptTimestamp, _path + ".scriptTimestamp", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".scriptTimestamp",
                expected: "(FirebaseFirestore.Timestamp | null)",
                value: input.scriptTimestamp
            }, errorFactory)) && ((Array.isArray(input.columnsReorganization) || $guard(_exceptionable, {
                path: _path + ".columnsReorganization",
                expected: "Array<__type>",
                value: input.columnsReorganization
            }, errorFactory)) && input.columnsReorganization.every((elem: any, _index1: number) => ("object" === typeof elem && null !== elem || $guard(_exceptionable, {
                path: _path + ".columnsReorganization[" + _index1 + "]",
                expected: "__type",
                value: elem
            }, errorFactory)) && $ao2(elem, _path + ".columnsReorganization[" + _index1 + "]", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".columnsReorganization[" + _index1 + "]",
                expected: "__type",
                value: elem
            }, errorFactory)) || $guard(_exceptionable, {
                ...
                expected: "Array<__type>",
                value: input.columnsReorganization
            }, errorFactory)) && (null === input.goalIndexesReorganizationTime || ("object" === typeof input.goalIndexesReorganizationTime && null !== input.goalIndexesReorganizationTime || $guard(_exceptionable, {
                path: _path + ".goalIndexesReorganizationTime",
                expected: "(FirebaseFirestore.Timestamp | null)",
                value: input.goalIndexesReorganizationTime
            }, errorFactory)) && $ao1(input.goalIndexesReorganizationTime, _path + ".goalIndexesReorganizationTime", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".goalIndexesReorganizationTime",
                expected: "(FirebaseFirestore.Timestamp | null)",
                value: input.goalIndexesReorganizationTime
            ...
            }, errorFactory)) && (null === input.taskIndexesReorganizationTime || ("object" === typeof input.taskIndexesReorganizationTime && null !== input.taskIndexesReorganizationTime || $guard(_exceptionable, {
                path: _path + ".taskIndexesReorganizationTime",
                expected: "(FirebaseFirestore.Timestamp | null)",
                value: input.taskIndexesReorganizationTime
            }, errorFactory)) && $ao1(input.taskIndexesReorganizationTime, _path + ".taskIndexesReorganizationTime", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".taskIndexesReorganizationTime",
                expected: "(FirebaseFirestore.Timestamp | null)",
                value: input.taskIndexesReorganizationTime
            }, errorFactory)) && (2 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).every((key: any) => {
