...
const validateWorkspaceSummaryDTO = (input: any): WorkspaceSummaryDTO => {
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is WorkspaceSummaryDTO => {
